...
const fhss_config_t domains[] = {
    ...
    // Ширина канала 600кГц, 40 каналов, центральная частота 750МГц (738.3 - 761.7); domain == 6
    {"RUS770", FREQ_HZ_TO_REG_VAL(758300000), FREQ_HZ_TO_REG_VAL(781700000), 40},
    // Ширина канала 600кГц, 40 каналов, центральная частота 770МГц (758.3 - 781.7); domain == 7
    {"RUS800", FREQ_HZ_TO_REG_VAL(788300000), FREQ_HZ_TO_REG_VAL(811700000), 40},
    // Ширина канала 600кГц, 40 каналов, центральная частота 800МГц (788.3 - 811.7); domain == 8
    {"RUS800UW", FREQ_HZ_TO_REG_VAL(808300000), FREQ_HZ_TO_REG_VAL(831700000), 40},
     // Ширина канала 600кГц, 40 каналов, центральная частота 800МГц (808.3 - 831.7); domain == 9
    {"RUS800UW", FREQ_HZ_TO_REG_VAL(770300000), FREQ_HZ_TO_REG_VAL(829700000), 100},
    // Ширина канала 600кГц, 200 каналов, центральная частота 800МГц (740.3 - 859.7); domain == 10
    {"RUS1000", FREQ_HZ_TO_REG_VAL(988300000), FREQ_HZ_TO_REG_VAL(1011700000), 40}
    // Ширина канала 600кГц, 40 каналов, центральная частота 1000МГц (988.3 - 1011.7); domain == 11
};
